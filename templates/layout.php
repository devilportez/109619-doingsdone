...
<html lang="ru">
    ...
    <body
        class="
            <?= (isset($modal)) ? "overlay" : "" ?>
            <?= (isset($_SESSION["user"]) || isset($_GET["register"]) || isset($_POST["register"])) ? "" : "body-background"; ?>
        "
    >
        ...
        <div class="page-wrapper">
            <div
                class="
                    container
                    <?= (isset($_SESSION["user"]) || isset($_GET["register"]) || isset($_POST["register"])) ? "container--with-sidebar" : ""; ?>
                "
            >
        ...
        <footer class="main-footer">
            <div class="container">
                ...
                <a
                    ...
                    href="<?= (isset($_SESSION["user"])) ? "?add_task" : "?login"; ?>"
                >
                    Добавить задачу
                </a>
